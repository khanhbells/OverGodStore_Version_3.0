...
?>
<div class="sticker-service">
    <div class="container">
        <div class="row parent">
            <div class="col-lg-3 col-md-3 col-sm-6 boxed">
                <div class="left">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:60px;height:60px;color:#000">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5" />
                    </svg>
                </div>
                <div class="right">
                    <h6>Giao hàng nhanh, miễn phí</h6>
                    <p>Đơn hàng > 400K toàn quốc hoặc 250K tại Hà Nội</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 boxed">
                <div class="left">
                ...
                <div class="right">
                    <h6>Trả hàng, Bảo hành</h6>
                    <p>Trả lại hoặc đổi hàng của bạn miễn phí </p>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 boxed">
                <div class="left">
                ...
                <div class="right">
                    <h6>Thành viên</h6>
                    <p>Ưu đã theo từng cấp bậc hạng thành viên.</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 boxed">
                <div class="left">
                ...
                <div class="right">
                    <h6>Chính hãng</h6>
                    <p>Sản phẩm chính hãng. Chất liệu và gia công hoàn toàn tại Việt Nam</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xs-12">
                <div class="section-title text-center">
                    <div class="product-tab nav nav-tabs">
                        <ul>
                            <li class="active"><a data-toggle="tab" href="#arrival">Đầm</a></li>
                            <li><a data-toggle="tab" href="#popular">Chân Váy </a></li>
                            <li><a data-toggle="tab" href="#best">Áo dài</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center tab-content">
            <div class="tab-pane  fade in active" id="arrival">
                <div class="wrapper">
                    ...
                    <button id="load-more-two">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:30px;height:30px;margin:10px;color:#000">
            ...
            <div class="tab-pane fade" id="best">
                <div class="wrapper">
                    ...
                    <button id="load-more-four" style="display:flex;align-items: center;justify-content: center;">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:30px;height:30px;margin:10px;color:#000">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 5.25 7.5 7.5 7.5-7.5m-15 6 7.5 7.5 7.5-7.5" />
                        </svg>
                    </button>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="collect-img banner margin single-colect">
                    <a href="#"><img src="public/<?= $data_random['1']['HinhAnh2'] ?>" alt="" /></a>
                </div>
            </div>
            <div class="col-sm-4">
        ...
        xhr.onload = function() {
            if (xhr.status === 200) {
                ...
                if (response.status === 'success') {
                    ...
                    // Optionally update the cart count or total
                    // Assuming you have an element with id 'cart-total'
                    var cartTotal = document.getElementById('cart-total');
                    if (cartTotal) {
                        cartTotal.innerText = response.total;
                    }
